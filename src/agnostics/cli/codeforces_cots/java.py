...
then provide a complete implementation in Java 24.
...
executor_image_name = 'agnostics-java-executor'

command_make_prompts = commands.CmdStandardMakePrompts(__file__, prompt_pl_suffix=PROMPT_JAVA_SUFFIX)
