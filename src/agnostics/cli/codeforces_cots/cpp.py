...
then provide a complete implementation in C++ (C++17 standard).
...
executor_image_name = 'agnostics-cpp-executor'

command_make_prompts = commands.CmdStandardMakePrompts(__file__, prompt_pl_suffix=PROMPT_CPP_SUFFIX)
