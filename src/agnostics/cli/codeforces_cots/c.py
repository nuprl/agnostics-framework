...
then provide a complete implementation in C (C11 standard).
...
executor_image_name = 'agnostics-c-executor'

command_make_prompts = commands.CmdStandardMakePrompts(__file__, prompt_pl_suffix=PROMPT_C_SUFFIX)
